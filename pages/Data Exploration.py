...
st.write("The data above is imported from the **yfinance** module, and it is just the ticker for Apple. Instead of specifically being apple, our app takes in your input and retrieves the necessary data for that.")
...
st.header("OpenAI Implementation")
st.write("Our app uses OpenAI to generate a computer summary of the inputted ticker. This is to make sure the user has the necessary info about the ticker they selected including stock history, general company facts, and more!") 
